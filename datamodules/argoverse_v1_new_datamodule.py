...
class ArgoverseV1NewDataModule(pl.LightningDataModule):
    ...
    def __init__(self,
                 ...
                 margin: float = 50,
                 **kwargs) -> None:
        super(ArgoverseV1NewDataModule, self).__init__()
        self.root = root
        ...
        self.train_transform = Compose(
            [HorizontalFlip(flip_p), AgentRandomOcclusion(agent_occlusion_ratio, num_historical_steps),
             LaneRandomOcclusion(lane_occlusion_ratio), TargetBuilder(num_historical_steps, num_future_steps)])
        self.val_transform = Compose([LaneRandomOcclusion(0.0), TargetBuilder(num_historical_steps, num_future_steps)])
